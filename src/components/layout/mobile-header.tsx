    ...
    return (
        <div>
            ...
            <div className={cn(
                ...
                <div className="relative px-6 pt-10 pb-8 border-b border-white/5 bg-[#0D0D0E]/50">
                    <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-2">
                            <img src="/logo-taleem.png" alt="TaleemApp" className="h-8 w-auto object-contain rounded-lg" />
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative group">
                            <div className="absolute -inset-1 bg-gradient-to-tr from-emerald-500 to-amber-400 rounded-2xl blur opacity-25" />
                ...
                <div className="flex-1 overflow-y-auto py-8 px-4 space-y-8 custom-scrollbar relative z-10 no-scrollbar">
                ...
                <div className="p-6 pb-10 border-t border-white/5 bg-[#0D0D0E]/80 backdrop-blur-md space-y-3 z-20">
                    ...
                    >
                        <Settings2 className="w-4 h-4 text-muted-foreground group-hover:text-emerald-500 transition-colors" />
                        <span className="text-[8px] font-black uppercase tracking-widest text-muted-foreground group-hover:text-white">Paramètres</span>
                    </Link>
